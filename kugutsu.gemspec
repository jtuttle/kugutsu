...
Gem::Specification.new do |spec|
  spec.name          = 'kugutsu'
  spec.version       = Kugutsu::VERSION
  spec.authors       = ['John Tuttle']
  spec.email         = ['jtuttle.develops@gmail.com']

  spec.summary       = 'A scripting system for Ruby'
  spec.description   = 'A scripting system for Ruby'
  spec.homepage      = 'https://github.com/jtuttle/kugutsu'
  spec.license       = 'MIT'
